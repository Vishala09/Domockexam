...
//backup before making wierd sectioning on question panel
   ...
   // let [currentIds, setcurrentIds] = useState([]);
    ...
    useEffect(() => {
        ...
        else
        {
            ...
            setQuestions({...qArr});
            setSections([...sects]);               //////////////FOR TRYING SECTIONING IN EXAM PANEL
            //setSections([...QuestionsByTest])
        }
    ...
    let myInterval = setInterval(() => {
        if(document.getElementById('minutes'))
            ...
            if(minutes==0 && seconds==0)
            {
                ...
                history.push({pathname:'/report',state:{TimeTaken:((Object.keys(Questions)?.length) * 60 )}});
            } 
        }, 1000)
        return ()=> {
            clearInterval(myInterval);
    ...
    return (
        <div className="container-fluid" id="domockexamtestpage" style={{height:window.screen.width>770 ?'85vh':''}}>
            {/* <NavigationBlocker /> */}
            {showModal && submitClicked && <Popup from="test" title="Submit Test" body="Are you sure you want to submit test?" returnStateHandler={returnStateHandler} />}
                        ...
                        <div className="col-md-8 col-12" > 
                            ...
                            <div className="row">
                            {
                                 ...
                                 <div className="d-flex flex-column" style={{overflow:'hidden'}}> 
                                     ...
                                     <Button variant="primary" className='' style={{width:'100px'}} onClick={()=>{setSubmitClicked(false);setcurrentSectionId(0)}}> Go Back </Button>
                                     <br></br>
                                 </div>
                                 :
